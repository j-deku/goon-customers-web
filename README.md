...
│   └── data.js                           # Seed data
│
├── goon-customers.postman_collection.json         # Ready-to-import Postman collection
```
...
```bash
git clone https://github.com/AppDefine/goon-customers-web.git
cd goon-customers-web
```
